...
class SortBufferBase {
 ...
 protected:
  ...
  virtual bool hasSpilled() const = 0;
  ...
  virtual void spillInput() = 0;

  virtual void spillOutput() = 0;

  virtual void prepareOutput(vector_size_t batchSize) = 0;

  virtual void getOutputWithoutSpill() = 0;

  virtual void getOutputWithSpill() = 0;
